                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 8),
                           Text("Remember me", style: TextStyle(fontSize: Dimensions.dynamicWidth(context, 0.035)),),
                        ],
                      ),
                      GestureDetector(
                        onTap: () => Get.to(() => ForgotPasswordScreen()),
                        child:  Text("Forgot Password?", style: TextStyle(fontSize: Dimensions.dynamicWidth(context, 0.035))),
                      ),
                    ],
                  ),
                  SizedBox(height: Dimensions.dynamicHeight(context, 0.02)),
